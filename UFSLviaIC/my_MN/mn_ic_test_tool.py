...
class ICTestTool(object):
    ...
    def __init__(self, feature_encoder, ic_model, data_root, batch_size=64, num_workers=8, ic_out_dim=512,transform=None,Config=''):
        ...
        self.train_loader = DataLoader(DatasetIC(self.data_train,Config=Config,transform=self.transform ), batch_size, False, num_workers=num_workers)
        self.val_loader = DataLoader(DatasetIC(self.data_val,Config=Config,transform=self.transform ), batch_size, False, num_workers=num_workers)
        self.test_loader = DataLoader(DatasetIC(self.data_test,Config=Config,transform=self.transform ), batch_size, False, num_workers=num_workers)
        pass
