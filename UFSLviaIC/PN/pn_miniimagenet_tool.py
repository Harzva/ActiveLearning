...
class RunnerTool(object):
    ...
    def adjust_learning_rate3(optimizer, epoch, first_epoch, t_epoch, init_learning_rate):
        ...
        if epoch < first_epoch + t_epoch * 0:  # 0-200
            learning_rate = init_learning_rate
        elif epoch < first_epoch + t_epoch * 1:  # 200-350
            learning_rate = init_learning_rate / 10
        elif epoch < first_epoch + t_epoch * 2:  # 350-500
            learning_rate = init_learning_rate / 100
        elif epoch < first_epoch + t_epoch * 3:  # 650-800
            learning_rate = init_learning_rate / (100*5)
        elif epoch < first_epoch + t_epoch * 4:  # 800-950
