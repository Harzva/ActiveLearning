    ...
    def train(self):
        ...
        for epoch in range(1, 1 + Config.train_epoch):
            ...
            if epoch % Config.val_freq == 0:
                ...
                self.test_tool_ic.val(episode=epoch, is_print=True)
                val_accuracy = self.test_tool_fsl.val(episode=epoch, is_print=True,Config=Config)
                ...
                if val_accuracy > self.best_accuracy:
                    ...
                    for i in glob.glob(os.path.dirname(Config.mn_dir)+'/*pkl'):
                        ...
                        os.remove(i)
                    torch.save(self.proto_net.state_dict(), os.path.dirname(Config.mn_dir)+'/'+'fsl-'+str(epoch)+os.path.basename(Config.mn_dir))
