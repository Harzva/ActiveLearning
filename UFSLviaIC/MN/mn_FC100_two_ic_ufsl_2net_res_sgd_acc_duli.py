...
class Config(object):
    ...
    mn_dir = Tools.new_dir("../models_mn/two_ic_ufsl_2net_res_sgd_acc_duli/{}_mn_{}way_{}shot_{}.pkl".format(model_name, num_way, num_shot,dataset))
    _root_path = "../models_mn/two_ic_ufsl_2net_res_sgd_acc_duli"
    ic_dir = Tools.new_dir("{}/{}_ic_{}.pkl".format(_root_path, model_name,dataset))
    pass
