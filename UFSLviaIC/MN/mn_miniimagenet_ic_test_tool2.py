...
class ICTestTool(object):
    ...
    def val(self, epoch, is_print=True,Config=""):
        if is_print:
            Config.logger.info("Test {} .......".format(epoch))
            pass
        ...
        if is_print:
            Config.logger.info("Epoch: {} KNN_train_acc {:.4f}/{:.4f} {:.4f}".format(epoch, acc_1_train , acc_2_train, acc_3_train))
            Config.logger.info("Epoch: {} KNN_val_acc   {:.4f}/{:.4f} {:.4f}".format(epoch, acc_1_val, acc_2_val, acc_3_val))
            Config.logger.info("Epoch: {} KNN_test_acc  {:.4f}/{:.4f} {:.4f}".format(epoch, acc_1_test, acc_2_test, acc_3_test))


            Config.writer.add_scalars('KNN_train_acc', {'top1 / total': acc_1_train,
                            'top5 / total': acc_2_train,
                            'acc_cluster':  acc_3_train}, epoch)
            Config.writer.add_scalars('KNN_val_acc', {'top1 / total': acc_1_val,
                            'top5 / total': acc_2_val,
                            'acc_cluster':  acc_3_val}, epoch)
            Config.writer.add_scalars('KNN_test_acc', {'top1 / total': acc_1_test,
