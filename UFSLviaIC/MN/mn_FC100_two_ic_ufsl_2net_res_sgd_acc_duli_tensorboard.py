...
from mn_miniimagenet_tool import MatchingNet, Normalize, RunnerTool,ResNet12Small,CNNEncoder,Classifier
...
class Runner(object):
    ...
    def load_model(self):
        ...
        ic_pkl_list=glob.glob(f'{os.path.dirname(Config.ic_dir)}/fsl*pkl')
        assert len(ic_pkl_list)==1 and os.path.exists(ic_pkl_list[0]),'len(pkl_list) must is 1 and pkl_list[0] must exist'
        self.matching_net.load_state_dict(torch.load(ic_pkl_list[0]))
        Config.logger.info("load matching net success from {}".format(ic_pkl_list[0]))
        pass
...
Harzva
harzva
2020-12-18 20:37:43 Test 1690 .......
2020-12-18 20:38:37 Epoch: 1690 Train 0.4713/0.7977 0.0000
2020-12-18 20:38:37 Epoch: 1690 Val   0.3417/0.7230 0.0000
2020-12-18 20:38:37 Epoch: 1690 Test  0.3310/0.7332 0.0000
2020-12-18 20:39:45 Train 1690 Accuracy: 0.6347777777777778
2020-12-18 20:39:45 Val   1690 Accuracy: 0.3231111111111111
2020-12-18 20:39:45 Test1 1690 Accuracy: 0.33155555555555555
2020-12-18 20:39:45 Test2 1690 Accuracy: 0.3397111111111111

2020-12-18 20:47:35 Test 1700 .......
2020-12-18 20:48:29 Epoch: 1700 Train 0.4767/0.7996 0.0000
2020-12-18 20:48:29 Epoch: 1700 Val   0.3398/0.7192 0.0000
2020-12-18 20:48:29 Epoch: 1700 Test  0.3337/0.7394 0.0000
2020-12-18 20:49:36 Train 1700 Accuracy: 0.6501111111111111
2020-12-18 20:49:36 Val   1700 Accuracy: 0.32699999999999996
2020-12-18 20:49:36 Test1 1700 Accuracy: 0.34855555555555556
2020-12-18 20:49:36 Test2 1700 Accuracy: 0.3418
