...
def parse_args():
    ...
    parser.add_argument('--baseline_type','-bt',type=int,default=0,help='baseline_type')         
...
class Config(object):
    ...
    baseline_type = baseline_type_list[args.baseline_type]
    ###############################################################################################
