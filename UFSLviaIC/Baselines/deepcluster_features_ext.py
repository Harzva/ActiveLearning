...
from UFSLTool import MyTransforms, MyDataset  as ToolDataset, C4Net, Normalize, RunnerTool, ResNet12Small, FSLTestTool
class VGG(nn.Module):
...
class ExtFeatures(object):
    ...
    def run_features(self, data_list):
        ...
        with torch.no_grad():
            ...
            loader = DataLoader(MyDataset(data_list,image_size=32), Config.batch_size, False, num_workers=Config.num_workers)
...
class Config(object):
    ...
    data_root=ToolDataset.get_data_root(dataset_name)
